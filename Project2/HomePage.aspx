...
<body>
    ...
    <h1 style="text-align:center; color:darkgoldenrod; font-family:'Bodoni MT'; font-weight:bold; text-align:center">Welcome to the Sunnydale High Course Registration System! </h1>
       <div style="text-align:center; width:100%">
         <asp:Button ID="btnNewStudent" runat="server" Text="Create Student" BackColor="DarkRed" ForeColor="White" Font-Bold="true" Font-Size="Large" style="width:218px; text-align: center"/>
       <br />
           <br />
       ...
       <br />
         ...
         <asp:Button ID="Button2" runat="server" Text="Search a Course" BackColor="DarkRed" ForeColor="White" Font-Bold="true" Font-Size="Large" style="width:218px; text-align: center"/>
        <br />
           <br />

        <asp:Button ID="Button3" runat="server" Text="View Bill" BackColor="DarkRed" ForeColor="White" Font-Bold="true" Font-Size="Large" style="width:218px; text-align: center"/>
        </div>
